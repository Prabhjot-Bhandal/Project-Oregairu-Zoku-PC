...
screen say(who, what):
    ...
    window:
        ...
        if who is not None:
            ...
            if who in ["Hachiman", "Taishi", "Tobe", "Hayato", "Student Council Vice President", "Male Staff", "Totsuka", "Announcer", "PE Teacher", "Stall-Keeper"]:
                window:
                    id "namebox"
                    style "namebox_blue"
                    text who id "who" xalign 0.5

            elif who in ["Komachi", "Magomachi", "Saki", "Hostess", "Yukino", "Yui", "Iroha", "Keika", "Hiratsuka", "Girl", "Girl A", "Girl B", "Girl C", "Yumiko", "Ebina", "Kaori", "Meguri", "Haruno", "Female Staff"]:
                window:
                    id "namebox"
                    style "namebox_pink"
                    text who id "who" xalign 0.5
...
style window:
    ...
    background Image("gui/overlay/textbox.png", xalign=0.5, yalign=1.0)
...
style namebox_blue:
    ...
    background Fixed("gui/overlay/namebox_blue.png")
...
style namebox_pink:
    ...
    background Fixed("gui/overlay/namebox_pink.png")
    padding gui.namebox_borders.padding
...
style namebox_grey:
    ...
    background Fixed("gui/overlay/namebox_grey.png")
    padding gui.namebox_borders.padding
...
screen add_button_main(i, name, act):
    fixed:
        if i != 0:
            ypos i * (gui.main_navigation_spacing + 96)
            xpos i * 10

        $ click = gui.sound_click
        $ confirm = gui.sound_confirm

        if name == "Start" and i == 0:
...
screen navigation():
    ...
    if main_menu:
        fixed:
            ...
            use add_button_main(0, _("Start"), Start())
            use add_button_main(1, _("Load"), ShowMenu("load"))
            use add_button_main(2, _("Settings"), ShowMenu("preferences"))

            if renpy.variant("pc"):
                use add_button_main(3, _("Quit"), Quit(confirm=not main_menu))
...
screen preferences():
    ...
    use game_menu(_("Options"), scroll=None):
        ...
        hbox:
            ...
            vbox:
                ...
                if renpy.variant("pc") or renpy.variant("web"):
                    label _("Display") text_color "#000000"
                    
                label _("Rollback Side") text_color "#000000"
                label _("Skip") text_color "#000000"

                label ""

                label _("Text Speed") text_color "#000000"
